/**
 * GA4 Measurement Protocol: the server-side `purchase`.
 *
 * The browser copy only counts buyers who return to a page of ours, and in
 * India most do not: a UPI payer completes inside their bank app and never
 * comes back to the tab. Same reason Meta's Purchase comes from the webhook.
 *
 ...
 * time and carried in the Razorpay notes. Without it the revenue still lands,
 * but as a new unattributed session, which breaks the funnel view.
 */
